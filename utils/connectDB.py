...
def establish_mongo_connection():
    ...
    try:
        ...
        config_hd_collection = db[CONFIG_HD_COLLECTION]
        config_dt_collection = db[CONFIG_DT_COLLECTION]
        filtered_data_collection = db[FILTERED_DATA_COLLECTION]
        
        return mongo_client, config_hd_collection, config_dt_collection, filtered_data_collection

    except Exception as e:
        handle_database_error(f"Error while establishing MongoDB connection: {e}")
